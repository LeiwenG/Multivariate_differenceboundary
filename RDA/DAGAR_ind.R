...
model.data1 <- list(k = n,  I = diag(ncol(X)), X = X, Y = Y, E = E, Ik = diag(n), index1 = index1,
                    alpha = 1, ncolumn = ncol(X),  H = 15,  ns = dni, udnei = udnei, cn = c(0, cni), mns=mns)
...
#pdf("est_diff_cancer_dagar_ind_pois.pdf", height = 10, width = 12)
...
#pdf("est_share_dagar_ind_pois.pdf", height = 10, width = 15)
