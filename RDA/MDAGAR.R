...
pdf("incidence_poission.pdf", height = 10, width = 12)
...
pdf("/Users/Leiwen/Box Sync/Research/boundaries_difference/paper/figures/smoking.pdf", height = 10, width = 12)
...
pdf("/Users/Leiwen/Box Sync/Research/boundaries_difference/paper/figures/MoranI.pdf", height = 5, width = 8)
...
##########################################################
### MDAGAR model using smoking rates as covariate only ###
##########################################################
...
beta_table = data.frame(matrix(beta_est, nrow = 2))
...
#pdf("est_diff_cancer_dagar_pois_smoke.pdf", height = 10, width = 12)
ggarrange(edge_plot1, edge_plot2, edge_plot3, edge_plot4, nrow = 2, ncol = 2)
#dev.off()

#################################################
### MDAGAR model using smoking and unemployed ###
#################################################
...
cov_effect = round(t(apply(mcmc_samples$beta, 2, mysummary)),3)
beta_est = paste(cov_effect[,1], " (", cov_effect[,2], ", ", cov_effect[,3], ")", sep="")
beta_table = data.frame(matrix(beta_est, nrow = 8))
...
#pdf("est_diff_cancer_dagar_pois_cov.pdf", height = 10, width = 12)
ggarrange(edge_plot1, edge_plot2, edge_plot3, edge_plot4, nrow = 2, ncol = 2)
#dev.off()
